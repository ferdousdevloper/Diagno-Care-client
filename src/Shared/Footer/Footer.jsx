...
const Footer = () => {
  return (
    <div>
      ...
      <div
          className="absolute -z-10 inset-0 bg-cover bg-center brightness-[10%]"
          style={{backgroundImage: "url('https://img.freepik.com/free-psd/interior-modern-emergency-room-with-empty-nurses-station-generative-ai_587448-2137.jpg')"}}
        ></div>
        <div className="container px-6 py-8 mx-auto">
          ...
          <Link
            ...
            data-aos-delay="500"
            className=" text-center font-bold flex flex-col items-center  w-full"
          >
            ...
            className="text-green-500 text-3xl">
              DIAGNO <span className="text-colorPrimary stroke-cyan-500">
                <Typewriter
            words={['CARE...']}
            loop={20}
            cursor
